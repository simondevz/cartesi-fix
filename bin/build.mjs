...
if (args[0] === "build") {
  if (args.length !== 2) {
    console.log("Usage: npx cartesi-fix build <image-hash>");
    process.exit(1);
  }
...
if (args[0] === "run") {
  ...
  if (first === "help") {
    console.log(
      "Usage: npx cartesi-fix <verbose> <block time in seconds default 5> <epoch_lenght default 720> <listening port default 8080>"
    );
    process.exit(1);
  }
